          ...
          >
            ...
            {!auth.isCompany && !auth.isAdmin && (
              <>
                ...
                >
                  <i className="fas fa-user"></i> {t('ProfileCandidate')}
                </Link>
                <Link className="dropdown-item" to={`/managecv`}>
                  <i className="fas fa-tasks"></i> {t('ManageCV')}
                </Link>
                <Link
                  className="dropdown-item"
                  to={`/savedjobs/${auth.user._id}`}
                >
                  <i className="fas fa-heart"></i> {t('SavedJobs')}
                </Link>
                <Link
                  className="dropdown-item"
                  to={`/appliedjobs/${auth.user._id}`}
                >
                  <i className="fas fa-briefcase"></i> {t('AppliedJobs')}
                </Link>
              </>
            )}
